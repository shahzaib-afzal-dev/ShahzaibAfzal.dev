...
const experiences = [
  {
    ...
    type: "Full-time",
    description:
      "Leading development of innovative web applications with focus on real-time features, scalable architecture, and multi-tenant systems.",
    responsibilities: [
      ...
      "Optimized database queries and added indexes where needed to improve API response times under load",
      "Implemented multi-tenant patterns (database or schema separation) to support multiple customers in the same codebase",
      "Overseeing the deployment process, including server configuration, load balancing, and monitoring to ensure optimal performance and uptime",
      "Migrated monolith features into small services or isolated modules to reduce deployment risk and speed up releases",
      "Led short project planning sessions (scoping, task breakdown, acceptance criteria) to align dev and product goals",
    ],
    technologies: ["Node.js", "React", "MongoDB", "WebSocket", "AWS", "Docker", "AI Integration", "Microservices"],
    achievements: [
      "Improved API response times through database optimization",
      "Successfully implemented multi-tenant architecture",
      "Reduced deployment risk by migrating to microservices",
    ],
  },
  {
    company: "Xenure.co",
    ...
    type: "Full-time",
    description:
      "Built and maintained robust web applications using the MERN stack with focus on performance, security, and user experience.",
    responsibilities: [
      "Developing a real-time chat application with integrated AI models for advanced features",
      "Implementing and managing secure payment systems to handle transactions and subscriptions",
      "Optimized database queries and added indexes where needed to improve API response times under load",
      ...
      "Wrote clean, efficient, and reusable code, adhering to best practices and leveraging asynchronous programming for seamless performance",
      "Integrated user authentication systems to enhance application security and user experience",
      "Utilized Git for version control",
      "Designed and implemented back-end solutions with Node.js and Express.js, alongside database management using MongoDB with Mongoose and MySQL",
      "Optimized application performance and ensured scalability",
    ],
    technologies: ["MongoDB", "Express.js", "React", "Node.js", "MySQL", "Mongoose", "Git", "JWT", "AI Integration"],
    achievements: [
      "Delivered multiple successful projects with real-time features",
      "Implemented secure payment systems and authentication",
      "Successfully migrated monolith to modular architecture",
    ],
  },
]
